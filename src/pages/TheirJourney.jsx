...
export default function TheirJourney() {
  return (
    <section id="journey" className="bg-white text-gray-800 py-16 px-4 sm:px-8 lg:px-16">
      <div className="max-w-6xl mx-auto">
        {/* Section Heading */}
        <div className="text-center mb-12">
          <h2 className="text-4xl font-extrabold leading-[1.2] pt-2  text-gray-900 mb-4">Their Journey</h2>
          ...
          <p className="text-md italic text-yellow-600 mt-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          {[
            ...
            <div
              key={idx}
              className="border-l-4 border-yellow-400 pl-4 py-4 bg-yellow-50/30 rounded-lg shadow-sm"
            >
              <h4 className="text-xl font-bold text-yellow-700">{station}</h4>
              <p className="text-sm text-gray-700">Area: {area}</p>
              <p className="text-sm text-gray-600">Years Served: {years}</p>
            </div>
          ))}
        </div>
        ...
        <div className="mb-12">
          <h3 className="text-2xl font-bold text-gray-800 mb-6">Key Responsibilities & Leadership Roles</h3>
        ...
        <div className="bg-yellow-100 border-l-4 border-yellow-500 p-6 rounded-lg">
          <h3 className="text-xl font-bold text-yellow-800 mb-2">🏁 Retirement Milestone</h3>
