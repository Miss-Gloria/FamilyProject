...
export default function MarriageLoveStory() {
  return (
    <section className="bg-gradient-to-br from-gray-900 via-purple-900 to-black text-white py-16 px-4 sm:px-8 lg:px-16">
      <div className="max-w-6xl mx-auto">
        {/* Section Header */}
        <div className="text-center mb-12">
          <h2 className="text-4xl font-extrabold leading-[1.2] pt-4 text-yellow-400 mb-4">Two Hearts, One Calling</h2>
        ...
        <div className="md:flex md:items-center gap-8">
          ...
          <div className="md:w-1/2 space-y-4">
            <ul className="text-gray-100 text-base leading-relaxed space-y-2">
            ...
            <p className="text-purple-300 italic mt-6">
